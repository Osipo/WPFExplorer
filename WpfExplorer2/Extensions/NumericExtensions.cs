...
namespace WpfExplorerControl.Extensions
{
    public static class NumericExtensions
    {
        ...
        public static bool IsClose(this decimal d1, decimal d2, decimal eps)
        {
            if (d1 == d2)
                return true;
            return Math.Abs(d1 - d2) < eps;
        ...
        public static bool IsClose(this decimal d1, decimal d2)
        {
            return d1.IsClose(d2, 0.01M);
        }
        ...
        public static decimal Sqrt(this decimal d, decimal eps)
        {
